...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = self.weights_hidden_to_output # hxo
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        output_error_term = error #1xo
        
        hidden_error_term = output_error_term.dot(hidden_error.T) * (hidden_outputs*(1-hidden_outputs)) # 1xH
    ...
    def run(self, features):
        ...
        final_inputs = hidden_outputs.dot(self.weights_hidden_to_output) # signals into final output layer
        final_outputs = final_inputs[0] # signals from final output layer 
